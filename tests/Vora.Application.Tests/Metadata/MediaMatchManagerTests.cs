...
public class MediaMatchManagerTests
{
    ...
    public async Task Search_uses_the_cleaned_title_when_no_query_is_given()
    {
        ...
        var results = await Manager().SearchAsync(DuplicateShowId, null, null);
    ...
    public async Task Search_uses_the_library_provider_for_a_show()
    {
        ...
        await Manager().SearchAsync(DuplicateShowId, "Dead City", null);
    ...
    public async Task Search_uses_movie_search_for_a_movie()
    {
        ...
        await Manager().SearchAsync(DuplicateShowId, null, 2016);
    ...
    public async Task Search_retries_without_the_year_when_the_year_finds_nothing()
    {
        ...
        await Manager().SearchAsync(DuplicateShowId, "Dead City", 2024);
    ...
    public async Task A_pasted_tmdb_movie_link_finds_nothing_for_a_show()
    {
        ...
        var results = await Manager().SearchAsync(DuplicateShowId, "https://www.themoviedb.org/movie/603-the-matrix", null);
    ...
    public async Task Applying_replaces_every_stale_id_with_the_chosen_one()
    {
        ...
        await Manager().ApplyAsync(show.Id, new ApplyMediaMatchRequest { Source = "tvdb", ExternalId = "417549" });
    ...
    public async Task Applying_queues_a_refresh_of_the_matched_item()
    {
        ...
        var result = await Manager().ApplyAsync(show.Id, new ApplyMediaMatchRequest { Source = "tmdb", ExternalId = "194583" });
    ...
    public async Task Applying_accepts_a_pasted_link_as_the_id()
    {
        ...
        await Manager().ApplyAsync(show.Id, new ApplyMediaMatchRequest { Source = "imdb", ExternalId = "https://www.imdb.com/title/tt18546730/" });
    ...
    public async Task Applying_to_a_show_that_already_exists_merges_them_and_points_at_the_survivor()
    {
        ...
        var result = await Manager().ApplyAsync(show.Id, new ApplyMediaMatchRequest { Source = "tvdb", ExternalId = "417549" });
    ...
    public async Task A_movie_is_never_merged()
    {
        ...
        var result = await Manager().ApplyAsync(movie.Id, new ApplyMediaMatchRequest { Source = "tmdb", ExternalId = "329865" });
