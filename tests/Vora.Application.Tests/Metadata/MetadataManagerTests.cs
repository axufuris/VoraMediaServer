...
public class MetadataManagerTests
{
    ...
    public async Task TriggerActorMetadataRefreshAsync_skips_custom_actors()
    {
        ...
        await _manager.TriggerActorMetadataRefreshAsync(TestContext.Current.CancellationToken);
    ...
    public async Task TriggerLibraryArtworkRefreshAsync_notifies_library_updated_at_end_even_when_no_items()
    {
        ...
        await _manager.TriggerLibraryArtworkRefreshAsync(libId, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task TriggerLibraryRatingsRefreshAsync_calls_repository_for_each_id_and_notifies()
    {
        ...
        await _manager.TriggerLibraryRatingsRefreshAsync(libId, cancellationToken: TestContext.Current.CancellationToken);
