...
public class MediaAnalyzerManagerDetectionTests
{
    ...
    public async Task RunMediaItemSilenceDetectionAsync_passes_probed_threshold_with_offset_to_analyzer()
    {
        ...
        await _manager.TriggerMediaItemSilenceDetectionAsync(id, forceOverride: true, cancellationToken: TestContext.Current.CancellationToken);
        ...
        await _analyzer.Received(1).AnalyzeSilenceDetectionsAsync("/m/a.mkv",
            Arg.Is<SilenceDetectionParameters>(p =>
                ...
                p.MinBlackFrameDurationSec == 1), TestContext.Current.CancellationToken);
    }
    ...
    public async Task RunMediaItemSilenceDetectionAsync_falls_back_to_minus_40_threshold_when_probe_returns_null()
    {
        ...
        await _analyzer.Received(1).AnalyzeSilenceDetectionsAsync("/m/a.mkv",
            Arg.Is<SilenceDetectionParameters>(p => p.NoiseThresholdDb == -40), TestContext.Current.CancellationToken);
    }
    ...
    public async Task RunMediaItemSilenceDetectionAsync_skips_when_library_detection_disabled_and_not_forced()
    {
        ...
        await _analyzer.DidNotReceiveWithAnyArgs().ProbeMeanVolumeDbAsync(string.Empty, TestContext.Current.CancellationToken);
    }
    ...
    public async Task Fingerprint_intro_skips_the_head_decode_and_overrides_the_intro()
    {
        ...
        await _manager.AnalyzeMediaItemMarkersAsync(id, isEpisode: true, forceOverride: true, fingerprintIntro, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task TriggerLibrarySilenceDetectionAsync_runs_when_forced_even_if_detections_are_never()
    {
        ...
        await _manager.TriggerLibrarySilenceDetectionAsync(Guid.NewGuid(), forceOverride: true, cancellationToken: TestContext.Current.CancellationToken);
