...
public class MediaAnalyzerManagerMarkerLockTests
{
    ...
    public async Task TriggerMediaItemSilenceDetectionAsync_bails_when_markers_locked()
    {
        ...
        await _manager.TriggerMediaItemSilenceDetectionAsync(mediaItemId, forceOverride: true, cancellationToken: TestContext.Current.CancellationToken);

        await _analyzer.DidNotReceiveWithAnyArgs().ProbeMeanVolumeDbAsync(default!, TestContext.Current.CancellationToken);
    ...
    public async Task TriggerMediaItemSilenceDetectionAsync_skips_when_trigger_gate_blocks()
    {
        ...
        await _manager.TriggerMediaItemSilenceDetectionAsync(mediaItemId, forceOverride: false, isAdditionTrigger: true, cancellationToken: TestContext.Current.CancellationToken);
        ...
        DetectionTrigger setting, bool isAddition, bool isSchedule)
    {
        ...
        await _manager.TriggerMediaItemSilenceDetectionAsync(
            ...
            isScheduleTrigger: isSchedule, cancellationToken: TestContext.Current.CancellationToken);
