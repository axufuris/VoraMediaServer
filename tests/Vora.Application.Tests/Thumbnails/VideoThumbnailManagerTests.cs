...
public class VideoThumbnailManagerTests
{
    ...
    public async Task TriggerMediaItemThumbnailGenerationAsync_skips_non_video_types()
    {
        ...
        await _manager.TriggerMediaItemThumbnailGenerationAsync(id, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task TriggerMediaItemThumbnailGenerationAsync_routes_tv_show_to_episode_ids()
    {
        ...
        await _manager.TriggerMediaItemThumbnailGenerationAsync(tvId, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task TriggerMediaItemThumbnailGenerationAsync_routes_season_to_episode_ids()
    {
        ...
        await _manager.TriggerMediaItemThumbnailGenerationAsync(seasonId, cancellationToken: TestContext.Current.CancellationToken);
