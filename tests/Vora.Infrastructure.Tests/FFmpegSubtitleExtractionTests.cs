...
public class FFmpegSubtitleExtractionTests : IDisposable
{
    ...
    public void A_cache_entry_matching_the_current_source_is_valid()
    {
        ...
        NewService().HasValidCachedWebVtt(_root, PartId, TrackId, source, 3).Should().BeTrue();
    }
    ...
    public void A_cache_entry_from_an_older_version_of_the_file_is_not_valid()
    {
        ...
        NewService().HasValidCachedWebVtt(_root, PartId, TrackId, source, 3).Should().BeFalse();
    }
    ...
    public void A_cache_entry_for_a_different_stream_index_is_not_valid()
    {
        ...
        NewService().HasValidCachedWebVtt(_root, PartId, TrackId, source, 4).Should().BeFalse();
    }
    ...
    {
        NewService().HasValidCachedWebVtt(_root, PartId, TrackId, "/no/such/file.mkv", 3).Should().BeFalse();
    }
