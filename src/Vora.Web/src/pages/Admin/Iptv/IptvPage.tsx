        ...
        <div data-vora-page="">
            ...
            <div className="px-8 pt-6 pb-10 max-w-[1400px] mx-auto">
                <FeatureToggle
                    ...
                    unavailableHint={isRadio
                        ? 'No radio source configured — this stays hidden for clients until a radio playlist is added below.'
                        : 'No Live TV source configured — this stays hidden for clients until a Live TV playlist is added below.'}
                    serverId={serverId}
                />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder={isRadio ? 'e.g. Top 100 Radio' : 'e.g. US — IPTV Org'}
                            />
                        </div>
                        <div>
