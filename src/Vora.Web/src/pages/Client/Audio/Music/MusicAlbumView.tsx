                            ...
                            {tracksInDisc.map(track => {
                                ...
                                return (
                                    <div
                                        ...
                                        className="w-full text-left flex items-center gap-2 sm:gap-4 p-2 vora-row-interactive border border-transparent rounded transition-all cursor-pointer group"
                                    >
                                        ...
                                        {/* Which tracks on the album are the hits. Shown here and
                                            not on the artist's Popular list, which is ordered by
                                            plays on this server first — a world-wide figure beside
