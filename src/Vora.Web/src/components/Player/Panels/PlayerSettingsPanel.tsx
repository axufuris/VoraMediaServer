...
interface PlayerSettingsPanelProps {
    ...
    // Switching video track can land on a different part, whose subtitle tracks
    // are not the ones currently listed — the owner clears the selection.
    onVideoPartChanged: () => void;
    onCancel: () => void;
    onApply: () => void;
}
