...
public class OpenAiRecommendationProvider : IRecommendationProvider
{
    ...
    public IEnumerable<PluginSettingDefinitionDto> GetSettingDefinitions()
    {
        return new List<PluginSettingDefinitionDto>
        {
            ...
            new PluginSettingDefinitionDto { Key = "chat_model", Label = "Chat Model", Type = "text", DefaultValue = "gpt-4o-mini", Description = "Model used for the nightly 'For You' recommendation generation. gpt-4o-mini is a good, inexpensive default for this batch job." },
            new PluginSettingDefinitionDto { Key = "collections_model", Label = "AI Collections Model", Type = "text", DefaultValue = "", Description = "Optional model used for AI collection lists and chronological ordering, which benefit from stronger reasoning. Leave blank to reuse the Chat Model above. Recommended: gpt-4o." },
