    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AdminThemeId", "BackgroundX264Preset", "BackupConfigurationJson", "BlackFrameMinDurationSec", "DailyMixCount", "DailyMixDriftPercent", "DailyMixLastRefreshedAt", "DailyMixMinPlays", "DailyMixSchedule", "DailyMixSize", "DefaultClientTemplateId", "DetectionScheduleTime", "DisableVideoTranscoding", "DvrAutoDeleteWatchedDays", "DvrConflictPolicy", "DvrDefaultSeriesRetention", "DvrMaxStorageGb", "DvrNotifyOnFailure", "DvrNotifyOnStorageThreshold", "DvrPostRollSeconds", "DvrPreRollSeconds", "DvrStoragePath", "DvrStorageWarningPercent", "EmailEnabled", "EmailPublicBaseUrl", "EnableDailyMixes", "EnableDiscover", "EnableDvr", "EnableForYou", "EnableHdrToneMapping", "EnableHevcEncoding", "EnableHevcOptimization", "EnableInternetRadio", "EnableLiveTv", "EnableNightlyScan", "EnablePodcasts", "EnableReleaseCalendar", "EnableRemoteAccess", "EnableWeeklyMixes", "EpisodeIntroClusterMinAgreementPct", "EpisodeIntroClusterToleranceSec", "FolderWatcherPollingInterval", "FolderWatcherProviderId", "HardwareTranscodingDevice", "InternetUploadSpeedMbps", "IptvSyncTime", "LocalMediaScannerProviderId", "ManuallySpecifyPublicPort", "MaxBackgroundTranscodes", "MaxCpuTranscodes", "MaxGpuTranscodes", "MaxRemoteStreamBitrateMbps", "NightlyScanTime", "PublicPort", "RegistrationMode", "RunDetections", "ServerName", "SilenceMinDurationEpisodeSec", "SilenceMinDurationMovieSec", "SilenceThresholdOffsetDb", "SmtpFromAddress", "SmtpFromDisplayName", "SmtpHost", "SmtpPasswordCiphertext", "SmtpPort", "SmtpUseImplicitSsl", "SmtpUseStartTls", "SmtpUsername", "StreamingProfile", "TmdbApiKey", "TonemappingAlgorithm", "TranscodeQuality", "TranscoderTempDirectory", "TranscoderThrottleBuffer", "TvdbApiKey", "TvdbToken", "UseHardwareAcceleration", "UseHardwareEncoding", "VideoThumbnailHeight", "VideoThumbnailIntervalSeconds", "VideoThumbnailJpegQuality", "VideoThumbnailScheduleTime", "VideoThumbnailSpriteColumns", "VideoThumbnailWidth", "WeeklyMixLastRefreshedAt" },
                values: new object[] { "GLOBAL_SETTINGS", "vora-default", 2, null, 0.5, 6, 20, null, 50, "Daily3am", 50, "vora-cinema", new TimeSpan(0, 3, 0, 0, 0), false, 0, 0, 0, 0L, true, true, 300, 120, null, 90, false, null, true, true, true, true, true, 1, true, true, true, false, true, true, true, true, 70, 5, 30, "polling_watcher", "Auto", 1000, new TimeSpan(0, 4, 0, 0, 0), "Vora_scanner", false, 0, 0, 2, 0, new TimeSpan(0, 2, 0, 0, 0), 32080, 2, 0, "Vora Server", 1.0, 1.5, -12, null, null, null, null, 587, false, true, null, 0, "37627bd54505a2f5f83df81303bc1eaa", "hable", 0, "/transcode", 60, "56c51421-6057-4825-bc6f-a550198c8fcc", null, true, true, 180, 10, 5, new TimeSpan(0, 4, 0, 0, 0), 10, 320, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("73c33c2c-1fe6-4885-875e-481a1dac5462"), null, null, null, null, null, 0, "{\"mediaTypes\":[\"Movie\",\"TvShow\",\"Season\"]}", true, true, null, 20, true, true, 1, "Recently Released Movies & Shows" },
