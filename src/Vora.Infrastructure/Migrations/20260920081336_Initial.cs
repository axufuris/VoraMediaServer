        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportedHdrFormats = table.Column<string>(type: "text", nullable: true),
                    MaxVideoBitDepth = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmartMediaType = table.Column<int>(type: "integer", nullable: true),
                    ChronologyItemsSignature = table.Column<string>(type: "text", nullable: true),
                    ContentSyncCacheJson = table.Column<string>(type: "text", nullable: true),
                    ExcludedMediaIdsJson = table.Column<string>(type: "text", nullable: true),
                    SyncIntervalDays = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    MirrorList = table.Column<bool>(type: "boolean", nullable: false),
                    ContentSyncedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ChronologySyncedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryFilter = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true),
                    EnableHealthCheck = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExcludeFilters = table.Column<string>(type: "text", nullable: false),
                    ...
                    EnablePreviewDetection = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    ProvidesReleaseCalendar = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScanIgnoredFolders = table.Column<string>(type: "text", nullable: false),
                    ...
                    SilenceThresholdOffsetDb = table.Column<int>(type: "integer", nullable: false),
                    SilenceMinDurationMovieSec = table.Column<double>(type: "double precision", nullable: false),
                    SilenceMinDurationEpisodeSec = table.Column<double>(type: "double precision", nullable: false),
                    BlackFrameMinDurationSec = table.Column<double>(type: "double precision", nullable: false),
                    EpisodeIntroClusterToleranceSec = table.Column<int>(type: "integer", nullable: false),
                    EpisodeIntroClusterMinAgreementPct = table.Column<int>(type: "integer", nullable: false),
                    AnalyzeConcurrency = table.Column<int>(type: "integer", nullable: false),
                    AnalyzeUseHardwareDecode = table.Column<bool>(type: "boolean", nullable: false),
                    VideoThumbnailGeneration = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailScheduleTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    VideoThumbnailIntervalSeconds = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailWidth = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailHeight = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailJpegQuality = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailSpriteColumns = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailConcurrency = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailUseHardwareDecode = table.Column<bool>(type: "boolean", nullable: false),
                    PreExtractSubtitlesOnScan = table.Column<bool>(type: "boolean", nullable: false),
                    IptvSyncTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    IptvHealthCheckTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    ...
                    SubtitleSearchProviderId = table.Column<string>(type: "text", nullable: false),
                    EnableTrashAutoPurge = table.Column<bool>(type: "boolean", nullable: false),
                    MissingMediaRetentionDays = table.Column<int>(type: "integer", nullable: false),
                    ResolveMovieTvdbIds = table.Column<bool>(type: "boolean", nullable: false),
                    MetadataLanguage = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    AutoEnableSubtitlesForForeignAudio = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    RemoteAccessExternalUrl = table.Column<string>(type: "text", nullable: true),
                    ...
                    HdrTonemapQuality = table.Column<string>(type: "text", nullable: false),
                    HdrTranscodeDownscale = table.Column<string>(type: "text", nullable: false),
                    ...
                    TimeshiftMaxSessionHours = table.Column<int>(type: "integer", nullable: false),
                    ...
                    SmtpUseImplicitSsl = table.Column<bool>(type: "boolean", nullable: false),
                    SmtpUsername = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    SmtpPasswordCiphertext = table.Column<string>(type: "text", nullable: true),
                    SmtpFromAddress = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    SmtpFromDisplayName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    EmailPublicBaseUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    BackupConfigurationJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailNotifyOnRequestAvailable = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedReleaseDate = table.Column<DateOnly>(type: "date", nullable: true),
                    AddedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreSourceRemux = table.Column<int>(type: "integer", nullable: false),
                    ScoreSourceBluRay = table.Column<int>(type: "integer", nullable: false),
                    ScoreSourceWebDl = table.Column<int>(type: "integer", nullable: false),
                    ScoreSourceWebRip = table.Column<int>(type: "integer", nullable: false),
                    ScoreSourceHdtv = table.Column<int>(type: "integer", nullable: false),
                    ScoreSourceDvd = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ScoreHdr10PlusBonus = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowtimesLocation = table.Column<string>(type: "text", nullable: true),
                    RadioPrefsJson = table.Column<string>(type: "text", nullable: true),
                    AutoSkipIntro = table.Column<bool>(type: "boolean", nullable: false),
                    AutoSkipCredits = table.Column<bool>(type: "boolean", nullable: false),
                    MinimumCreditsSceneSeconds = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingsCheckedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PosterUrl = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    ...
                    AddedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastContentAddedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    OverlayLayoutVersion = table.Column<int>(type: "integer", nullable: true),
                    MarkersAnalyzedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastVideoThumbnailGenerationAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    VideoThumbnailSpriteVersion = table.Column<string>(type: "text", nullable: true),
                    VideoThumbnailSpriteCount = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailIntervalSeconds = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailSpriteColumns = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailWidth = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailHeight = table.Column<int>(type: "integer", nullable: false),
                    ...
                    EpisodeNumber = table.Column<int>(type: "integer", nullable: true),
                    EndEpisodeNumber = table.Column<int>(type: "integer", nullable: true),
                    ...
                    TheatricalReleaseDate = table.Column<DateOnly>(type: "date", nullable: true),
                    DigitalReleaseDate = table.Column<DateOnly>(type: "date", nullable: true),
                    SeasonNumber = table.Column<int>(type: "integer", nullable: true),
                    ...
                    NextAirDate = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InUniverseYear = table.Column<double>(type: "double precision", nullable: true),
                    InUniverseYearLocked = table.Column<bool>(type: "boolean", nullable: false),
                    ManuallyAdded = table.Column<bool>(type: "boolean", nullable: false),
                    AddedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutputResolution = table.Column<string>(type: "text", nullable: true),
                    OutputHdrType = table.Column<string>(type: "text", nullable: true),
                    ...
                    MediaItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    ExtraId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailSourcePartId = table.Column<Guid>(type: "uuid", nullable: true),
                    VideoThumbnailSpriteVersion = table.Column<string>(type: "text", nullable: true),
                    VideoThumbnailSpriteCount = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailIntervalSeconds = table.Column<int>(type: "integer", nullable: false),
                    VideoThumbnailSpriteColumns = table.Column<int>(type: "integer", nullable: false),
                    ...
                    VideoThumbnailHeight = table.Column<int>(type: "integer", nullable: false),
                    MediaItemId = table.Column<Guid>(type: "uuid", nullable: true),
                    MediaExtraId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ExternalFilePath = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    ...
                    IsHearingImpaired = table.Column<bool>(type: "boolean", nullable: false),
                    MediaPartId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AdminThemeId", "AnalyzeConcurrency", "AnalyzeUseHardwareDecode", "AutoEnableSubtitlesForForeignAudio", "BackgroundX264Preset", "BackupConfigurationJson", "BlackFrameMinDurationSec", "DailyMixCount", "DailyMixDriftPercent", "DailyMixLastRefreshedAt", "DailyMixMinPlays", "DailyMixSchedule", "DailyMixSize", "DefaultClientTemplateId", "DetectionScheduleTime", "DisableVideoTranscoding", "DvrAutoDeleteWatchedDays", "DvrConflictPolicy", "DvrDefaultSeriesRetention", "DvrMaxStorageGb", "DvrNotifyOnFailure", "DvrNotifyOnStorageThreshold", "DvrPostRollSeconds", "DvrPreRollSeconds", "DvrStoragePath", "DvrStorageWarningPercent", "EmailEnabled", "EmailPublicBaseUrl", "EnableDailyMixes", "EnableDiscover", "EnableDvr", "EnableForYou", "EnableHdrToneMapping", "EnableHevcEncoding", "EnableHevcOptimization", "EnableInternetRadio", "EnableLiveTv", "EnableNightlyScan", "EnablePodcasts", "EnableReleaseCalendar", "EnableRemoteAccess", "EnableTrashAutoPurge", "EnableWeeklyMixes", "EpisodeIntroClusterMinAgreementPct", "EpisodeIntroClusterToleranceSec", "FolderWatcherPollingInterval", "FolderWatcherProviderId", "HardwareTranscodingDevice", "HdrTonemapQuality", "HdrTranscodeDownscale", "InternetUploadSpeedMbps", "IptvHealthCheckTime", "IptvSyncTime", "LocalMediaScannerProviderId", "ManuallySpecifyPublicPort", "MaxBackgroundTranscodes", "MaxCpuTranscodes", "MaxGpuTranscodes", "MaxRemoteStreamBitrateMbps", "MetadataLanguage", "MissingMediaRetentionDays", "NightlyScanTime", "PreExtractSubtitlesOnScan", "PublicPort", "RegistrationMode", "RemoteAccessExternalUrl", "ResolveMovieTvdbIds", "RunDetections", "ScanIgnoredFolders", "ServerName", "SilenceMinDurationEpisodeSec", "SilenceMinDurationMovieSec", "SilenceThresholdOffsetDb", "SmtpFromAddress", "SmtpFromDisplayName", "SmtpHost", "SmtpPasswordCiphertext", "SmtpPort", "SmtpUseImplicitSsl", "SmtpUseStartTls", "SmtpUsername", "StreamingProfile", "SubtitleSearchProviderId", "TimeshiftMaxSessionHours", "TonemappingAlgorithm", "TranscodeQuality", "TranscoderTempDirectory", "TranscoderThrottleBuffer", "UseHardwareAcceleration", "UseHardwareEncoding", "VideoThumbnailConcurrency", "VideoThumbnailGeneration", "VideoThumbnailHeight", "VideoThumbnailIntervalSeconds", "VideoThumbnailJpegQuality", "VideoThumbnailScheduleTime", "VideoThumbnailSpriteColumns", "VideoThumbnailUseHardwareDecode", "VideoThumbnailWidth", "WeeklyMixLastRefreshedAt" },
                values: new object[] { "GLOBAL_SETTINGS", "vora-dark", 2, true, false, 2, null, 0.5, 6, 20, null, 50, "Daily3am", 50, "vora-cinema", new TimeSpan(0, 3, 0, 0, 0), false, 0, 0, 0, 0L, true, true, 300, 120, null, 90, false, null, true, true, true, true, true, 1, true, true, true, false, true, true, true, true, true, 70, 5, 30, "polling_watcher", "Auto", "Auto", "Auto", 1000, new TimeSpan(0, 4, 30, 0, 0), new TimeSpan(0, 4, 0, 0, 0), "Vora_scanner", false, 0, 0, 2, 0, "eng", 30, new TimeSpan(0, 2, 0, 0, 0), true, 32080, 2, null, false, 0, "[\".recycle\"]", "Vora Server", 1.0, 1.5, -12, null, null, null, null, 587, false, true, null, 0, "", 6, "hable", 0, "/transcode", 60, true, true, 2, 2, 90, 10, 9, new TimeSpan(0, 4, 0, 0, 0), 10, true, 160, null });

            migrationBuilder.InsertData(
                table: "SmartLists",
                columns: new[] { "Id", "ActiveEndDay", "ActiveEndMonth", "ActiveStartDay", "ActiveStartMonth", "CollectionId", "DisplayOrder", "FilterRulesJson", "LibraryId", "MaxItems", "ShowOnHomepage", "ShowToFriends", "SortBy", "Title" },
                values: new object[,]
                {
                    { new Guid("17ddede2-2de0-42b8-9b33-32708b4d29b8"), null, null, null, null, null, 1, "{\"mediaTypes\":[\"Movie\",\"TvShow\",\"Season\",\"Episode\"]}", null, 20, true, true, 0, "Recently Added Movies & Shows" },
                    { new Guid("58424b85-b6da-4a9c-8204-e364f1319508"), null, null, null, null, null, 4, "{\"mediaTypes\":[\"Episode\"]}", null, 20, true, true, 1, "Recently Released Episodes" },
                    { new Guid("73c33c2c-1fe6-4885-875e-481a1dac5462"), null, null, null, null, null, 0, "{\"mediaTypes\":[\"Movie\",\"Episode\"]}", null, 20, true, true, 1, "Recently Released Movies & Episodes" },
                    { new Guid("c88d6c8a-57ea-4b24-a7be-3f2638a38aca"), null, null, null, null, null, 3, "{\"mediaTypes\":[\"Movie\"]}", null, 20, true, true, 0, "Recently Added Movies" },
                    { new Guid("dfc420d4-421c-4e14-aec4-a5bedefd2f2e"), null, null, null, null, null, 5, "{\"mediaTypes\":[\"TvShow\"]}", null, 20, true, true, 0, "Recently Added Shows" },
                    { new Guid("ebbefd92-4232-4cae-9c5d-2134943b8bf8"), null, null, null, null, null, 2, "{\"mediaTypes\":[\"Movie\"]}", null, 20, true, true, 1, "Recently Released Movies" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailDeliveryLogs_Status_CreatedAt",
                table: "EmailDeliveryLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IptvChannels_PlaylistId_ExternalChannelId",
                table: "IptvChannels",
                columns: new[] { "PlaylistId", "ExternalChannelId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IptvChannels_PlaylistId_Kind",
                table: "IptvChannels",
                columns: new[] { "PlaylistId", "Kind" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IptvRecordingSessions_EndTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IptvRecordingSessions_Status",
                table: "IptvRecordingSessions",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_IptvRecordingSessions_Status_StartTime",
                table: "IptvRecordingSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaItemEmbeddings_Embedding",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StreamSessions_UserId_StartedAt",
                table: "StreamSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_SecurityStamp",
                table: "UserProfiles",
