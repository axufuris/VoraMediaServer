...
This file covers: how the OpenAPI doc is produced, how to harden it for codegen, and concrete commands for generating Swift and Kotlin clients. Why the clients are native per ecosystem is in [`docs/architecture.md`](../architecture.md).
